...
import { Search, Star, Download, Clock, TrendingUp } from "lucide-react";
...
export const MarketplacePage: React.FC = () => {
  ...
  const { agents, loading, pagination, fetchAgents, importAgent } =
    useMarketplace();
  ...
  const handleCategoryChange = (category: string) => {
    ...
    const categoryFilter =
      category === "All" ? undefined : category.toLowerCase();
