  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      type: 'system',
      content: 'Welcome! I\'m your AI assistant powered by Gemma 3. I can help you with various questions and tasks.',
      timestamp: new Date()
    }
  ]);
      ...
      <div style={{ 
        ...
        {isLoading && (
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ color: '#666', fontSize: '14px' }}>Processing...</span>
          </div>
        )}
